...
class Panel_home ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_notebook2.AddPage( self.anggota, u"Data Anggota", True )
...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText14 = wx.StaticText( self.panel_login, wx.ID_ANY, u"Log In", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText14.Wrap( -1 )
		...
		self.m_staticText9 = wx.StaticText( self.panel_login, wx.ID_ANY, u"Username", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText9.Wrap( -1 )
		fgSizer2.Add( self.m_staticText9, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.m_textCtrl5 = wx.TextCtrl( self.panel_login, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer2.Add( self.m_textCtrl5, 0, wx.ALL|wx.ALIGN_BOTTOM, 5 )
		
		self.m_staticText10 = wx.StaticText( self.panel_login, wx.ID_ANY, u"Password", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText10.Wrap( -1 )
		fgSizer2.Add( self.m_staticText10, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.m_textCtrl6 = wx.TextCtrl( self.panel_login, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer2.Add( self.m_textCtrl6, 0, wx.ALL, 5 )
		
		self.m_button4 = wx.Button( self.panel_login, wx.ID_ANY, u"Log in", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer6.Add( self.panel_login, 1, wx.EXPAND |wx.ALL, 5 )
